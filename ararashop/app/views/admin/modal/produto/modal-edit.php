              ...
              <form action="/produtosadm/updateprodutos" method="POST">
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" value="<?= $itemProdutos->nome ?>" name="nome">
                    <input required type="text" class="form-control" name="nome" id="input-nome" placeholder="<?= $itemProdutos->nome ?>">
                  </div>

                  <div class="form-group">
                    <label for="input-descricao">Descrição</label>
                    <input type="hidden" value="<?= $itemProdutos->descricao ?>" name="descricao">
                    <textarea required class="form-control" name="descricao" id="input-nome" placeholder="<?= $itemProdutos->descricao ?>" rows="3"></textarea>
                  </div>

                  <div class="form-group">
                    <label for="input-nome">Preço</label>
                    <input type="hidden" value="<?= $itemProdutos->preco ?>" name="preco">
                    <input required step="0.01" type="number" class="form-control" name="preco" id="input-nome" placeholder="R$ <?= number_format($itemProdutos->preco, 2, ',') ?>">
                  </div>

                  <div class="form-group">
                    <label for="input-imagem">Nova Imagem Principal do Produto</label>
                    <input type="hidden" value="<?= $itemProdutos->imagem ?>" name="imagem">
                  ...
                  <div class="form-check form-check-inline">
                    ...
                    <input type="hidden" value="<?= $itemProdutos->categoria ?>" name="categoria">
